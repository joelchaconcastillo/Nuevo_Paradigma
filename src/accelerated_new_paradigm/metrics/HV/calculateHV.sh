...
algname=(POF)
  ...
  #   alg=($alg"/POF/")
     ...
     do
  	   rm ${algname[$cont]}/${i}_2_${CR} 
  	   for file in ../$alg/${i}_2*_${CR}
  	   do
  #	       >>${algname[${cont}]}/${i}_2
   	      v1=$(./hv -r "2.2 4.4" $file)
  	      v1="${v1:-0}"
  	      v2=$(./hv -r "2.2 4.4" ../Optimals/${i}_2.txt )
               echo print ${v1}/${v2} | perl  >> ${algname[${cont}]}/${i}_2_${CR}
              echo "" >>${algname[${cont}]}/${i}_2_${CR}
  	   done
     done
  ...
  #################3obj
     for i in WFG1 WFG2 WFG3 WFG4 WFG5 WFG6 WFG7 WFG8 WFG9;
     do
  	   rm ${algname[$cont]}/${i}_3_${CR}

  
  	   for file in ../$alg/${i}_3*_${CR}

  	   do
  	      v1=$(./hv -r "2.2 4.4 6.6" $file)
  	      v1="${v1:-0}"
  	      v2=$(./hv -r "2.2 4.4 6.6" ../Optimals/${i}_3.txt )
                echo print ${v1}/${v2} | perl  >> ${algname[${cont}]}/${i}_3_${CR}

                echo "" >>${algname[${cont}]}/${i}_3_${CR}
